...
<body>
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="datacheck.php">HEALTH CENTER</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        
        <li class="dropdown"><a href="change_password.php" class="dropdown-toggle" data-toggle="dropdown"><?php echo $_SESSION['username']; ?><span class="caret"></span></a>
...
<?php
   ...
   $query1 = "SELECT * FROM Users WHERE username = '$email_id'";
   ...
   if($current_pass == $curr_password){
       ...
       if($new_password == $retype_new_password){
             $query2 = "UPDATE Users SET pass_word = '$new_password' WHERE username = '$email_id'";
