...
<center><h1> Lab Details </h1></center> 
<br><br><br>
    <center>
     <div class="class1"> 
<center>
...
echo "<br><br>";
 	...
 	$sql = "SELECT name,rollno,test,result,labreport,examinedby,date
  FROM lab";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
      ...
      $x=1;
                         ...
                         echo "<h3>Date: " . $row["date"]."<br> ". "Test: " . $row["test"]. " <br> ". "Result : " . $row["result"]. "<br> "."Lab report By :".$row["labreport"]."<br>"." Examined By :".$row["examinedby"] ." <br></h3> ".  "<hr>" ;
    }
  }   }
